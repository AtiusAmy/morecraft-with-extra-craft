...
public class Modeltokay_gecko<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "tokay_gecko"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(
				-4.0F, 1.0F, -5.0F, 8.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 18.0F, 0.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 14).addBox(
				-4.0F, 0.0F, -6.0F, 8.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 18.0F, -5.0F));

		PartDefinition tail = partdefinition.addOrReplaceChild("tail",
				CubeListBuilder.create().texOffs(19, 16).addBox(-2.0F, 2.5F, 0.0F, 4.0F, 2.0F, 9.0F,
		...
		PartDefinition front_left_leg = partdefinition.addOrReplaceChild("front_left_leg", CubeListBuilder.create()
				.texOffs(0, 5).addBox(-1.5F, 2.0F, -1.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition back_left_leg = partdefinition.addOrReplaceChild("back_left_leg", CubeListBuilder.create()
				.texOffs(22, 18).addBox(-0.5F, 4.0F, 0.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(4.0F, 19.0F, 3.0F));

		PartDefinition cube_r1 = back_left_leg
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(0, 14).addBox(0.0F, 1.0F, -2.0F, 2.0F, 3.0F, 1.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition front_right_leg = partdefinition.addOrReplaceChild("front_right_leg", CubeListBuilder.create()
				.texOffs(0, 0).addBox(-1.5F, 2.0F, -1.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-4.0F, 19.0F, -4.0F));

		PartDefinition back_right_leg = partdefinition.addOrReplaceChild("back_right_leg", CubeListBuilder.create()
				.texOffs(0, 18).addBox(-1.5F, 4.0F, 0.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-4.0F, 19.0F, 3.0F));

		PartDefinition cube_r2 = back_right_leg
				.addOrReplaceChild("cube_r2",
						CubeListBuilder.create().texOffs(22, 14).addBox(0.0F, 1.0F, -2.0F, 2.0F, 3.0F, 1.0F,
								new CubeDeformation(0.0F)),
